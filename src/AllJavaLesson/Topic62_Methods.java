...
public class Topic62_Methods {
    public static void PrintName(){
        System.out.println("my name is Scarlett"); // code block

    }
    public static void main (String[] args) { //bu kisim senin evin ve giriyorsun buraya bunu yazmak zorundasin
    ...
    public static void PrintLastName(){
        ...
        System.out.println("my last name is Ersan");
    }
